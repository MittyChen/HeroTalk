...
void Share::share()
{
    if(AgentManager::getInstance()->getSharePlugin())
    {
        ...
        info["titleUrl"] = "http://pan.baidu.com/s/1kTzn08n";
        // site是分享此内容的网站名称，仅在QQ空间使用
        info["site"] = "dot dot world";
        // siteUrl是分享此内容的网站地址，仅在QQ空间使用
        info["siteUrl"] = "http://pan.baidu.com/s/1kTzn08n";
        ...
        info["imagePath"] = "/sdcard/testImg.png";
        
        // url仅在微信（包括好友和朋友圈）中使用
        info["url"] ="http://pan.baidu.com/s/1kTzn08n";
